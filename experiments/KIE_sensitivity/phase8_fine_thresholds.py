...
Output:
  ...
  figures/fig13_fine_threshold.png
  figures/fig14_temporal_stability.png
"""
...
def main():
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR / "fig13_fine_threshold.png", dpi=300, bbox_inches='tight')
    plt.close()
    print(f"\n  Figure 13 saved: {FIG_DIR / 'fig13_fine_threshold.png'}")
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR / "fig14_temporal_stability.png", dpi=300, bbox_inches='tight')
    plt.close()
    print(f"  Figure 14 saved: {FIG_DIR / 'fig14_temporal_stability.png'}")
